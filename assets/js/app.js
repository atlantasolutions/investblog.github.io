function Slider($sliderContainer) {
	...
	function init() {
		var $pager = $("<span style=\"visibility:hidden\"/>");
		...
		$("<a class='back'><i class=\"fas fa-chevron-left\"></i></a>").prependTo($nav)
		.on("touchstart", function(e) {
			e.preventDefault();
			$(this).one("touchend", function(e) {
				e.preventDefault();
		...
		$("<a class='forth'> <i class=\"fas fa-chevron-right\"></i> </a>").appendTo($nav)
		.on("touchstart", function(e) {
			e.preventDefault();
			$(this).one("touchend", function(e) {
				e.preventDefault();
